define("crm-modules/common/echarts/component/helper/SelectController", [ "crm-modules/common/echarts/zrender/mixin/Eventful", "crm-modules/common/echarts/zrender/core/util", "../../util/graphic" ], function(require, exports, module) {
    ...
    function shouldShowCover() {
        ...
        var dx = p2[0] - p1[0];
        var dy = p2[1] - p1[1];
        var dist = mathPow(dx * dx + dy * dy, .5);
