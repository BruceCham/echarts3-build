define("crm-modules/common/echarts/component/axis/AngleAxisView", [ "crm-modules/common/echarts/zrender/core/util", "../../util/graphic", "../../model/Model", "../../echarts" ], function(require, exports, module) {
    "use strict";
    ...
    require("../../echarts").extendComponentView({
        ...
        _axisLabel: function(angleAxisModel, polar, ticksAngles, radiusExtent) {
            ...
            for (var i = 0; i < ticksAngles.length; i++) {
                ...
                var labelTextBaseline = Math.abs(p[1] - cy) / r < .3 ? "middle" : p[1] > cy ? "top" : "bottom";
