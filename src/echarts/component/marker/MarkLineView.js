define("crm-modules/common/echarts/component/marker/MarkLineView", [ "crm-modules/common/echarts/zrender/core/util", "../../data/List", "../../util/format", "../../util/model", "../../util/number", "./markerHelper", "../../chart/helper/LineDraw", "../../echarts" ], function(require, exports, module) {
    ...
    var markLineTransform = function(data, coordSys, baseAxis, valueAxis, precision, item) {
        ...
        item = [ markerHelper.dataTransform(data, coordSys, item[0]), markerHelper.dataTransform(data, coordSys, item[1]), zrUtil.extend({}, item[2]) ];
