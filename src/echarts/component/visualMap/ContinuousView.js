define("crm-modules/common/echarts/component/visualMap/ContinuousView", [ "./VisualMapView", "../../util/graphic", "crm-modules/common/echarts/zrender/core/util", "../../util/number", "../helper/sliderMove", "crm-modules/common/echarts/zrender/graphic/LinearGradient", "./helper" ], function(require, exports, module) {
    ...
    var LinearGradient = require("crm-modules/common/echarts/zrender/graphic/LinearGradient");
    ...
    var ContinuousVisualMapView = VisualMapView.extend({
        ...
        _resetInterval: function() {
            ...
            this._handleEnds = linearMap(dataInterval, visualMapModel.getExtent(), [ 0, visualMapModel.itemSize[1] ], true);
        },
        _updateInterval: function(handleIndex, delta) {
            ...
            this._dataInterval = linearMap(handleEnds, [ 0, visualMapModel.itemSize[1] ], visualMapModel.getExtent(), true);
        },
