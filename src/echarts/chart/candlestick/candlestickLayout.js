define("crm-modules/common/echarts/chart/candlestick/candlestickLayout", [], function(require, exports, module) {
    ...
    function calculateCandleWidth(seriesModel, data) {
        ...
        var extent;
        var bandWidth = baseAxis.type === "category" ? baseAxis.getBandWidth() : (extent = baseAxis.getExtent(), 
