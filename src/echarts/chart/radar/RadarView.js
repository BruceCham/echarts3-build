define("crm-modules/common/echarts/chart/radar/RadarView", [ "../helper/SymbolDraw", "../../util/graphic", "crm-modules/common/echarts/zrender/core/util", "../../echarts" ], function(require, exports, module) {
    ...
    return require("../../echarts").extendChartView({
        ...
        render: function(seriesModel, ecModel, api) {
            ...
            polyline.setStyle(zrUtil.extend(seriesModel.getModel("lineStyle.normal").getLineStyle(), {
