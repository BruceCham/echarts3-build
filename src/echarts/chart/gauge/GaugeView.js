define("crm-modules/common/echarts/chart/gauge/GaugeView", [ "./PointerPath", "../../util/graphic", "../../util/number", "../../view/Chart" ], function(require, exports, module) {
                ...
                if (labelModel.get("show")) {
                    ...
                    var text = new graphic.Text({
                        style: {
                            ...
                            textBaseline: unitY < -.4 ? "top" : unitY > .4 ? "bottom" : "middle",
                            textAlign: unitX < -.4 ? "left" : unitX > .4 ? "right" : "center"
                        },
                        silent: true
                    });
