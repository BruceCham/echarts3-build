define("crm-modules/common/echarts/chart/helper/EffectLine", [ "../../util/graphic", "./Line", "crm-modules/common/echarts/zrender/core/util", "../../util/symbol", "crm-modules/common/echarts/zrender/core/curve" ], function(require, exports, module) {
    var graphic = require("../../util/graphic");
    var Line = require("./Line");
    var zrUtil = require("crm-modules/common/echarts/zrender/core/util");
    var symbolUtil = require("../../util/symbol");
    var curveUtil = require("crm-modules/common/echarts/zrender/core/curve");
    ...
    effectLineProto._updateEffectSymbol = function(lineData, idx) {
        ...
        if (this._symbolType !== symbolType || period !== this._period) {
            symbol = symbolUtil.createSymbol(symbolType, -.5, -.5, 1, 1, color);
            symbol.ignore = true;
            symbol.z2 = 100;
