define("crm-modules/common/echarts/chart/helper/Line", [ "../../util/symbol", "crm-modules/common/echarts/zrender/core/vector", "./LinePath", "../../util/graphic", "crm-modules/common/echarts/zrender/core/util", "../../util/number" ], function(require, exports, module) {
    ...
    function updateSymbolBeforeLineUpdate() {
        ...
        if (label.__position === "end") {
            ...
            textBaseline = d[1] > .8 ? "top" : d[1] < -.8 ? "bottom" : "middle";
        } else {
            textPosition = [ -d[0] * 5 + fromPos[0], -d[1] * 5 + fromPos[1] ];
            textAlign = d[0] > .8 ? "right" : d[0] < -.8 ? "left" : "center";
            textBaseline = d[1] > .8 ? "bottom" : d[1] < -.8 ? "top" : "middle";
        }
        label.attr({
            style: {
