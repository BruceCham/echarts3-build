define("crm-modules/common/echarts/chart/helper/EffectSymbol", [ "crm-modules/common/echarts/zrender/core/util", "../../util/symbol", "../../util/graphic", "../../util/number", "./Symbol" ], function(require, exports, module) {
    ...
    effectSymbolProto.startEffectAnimation = function(period, brushType, rippleScale, effectOffset, z, zlevel) {
        ...
        for (var i = 0; i < EFFECT_RIPPLE_NUMBER; i++) {
            var ripplePath = symbolUtil.createSymbol(symbolType, -.5, -.5, 1, 1, color);
            ripplePath.attr({
                style: {
    ...
    effectSymbolProto.updateData = function(data, idx) {
        ...
        var effectPeriod = itemModel.get("rippleEffect.period") * 1e3;
