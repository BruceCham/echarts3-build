define("crm-modules/common/echarts/model/Global", [ "crm-modules/common/echarts/zrender/core/util", "./Model", "./Component", "./globalDefault" ], function(require, exports, module) {
    ...
    function mappingToExists(existCpts, newCptOptions) {
        ...
        each(newCptOptions, function(cptOption, index) {
            ...
            for (var i = 0; i < result.length; i++) {
                ...
                if (!result[i].option && (cptOption.id != null && exist.id === cptOption.id + "" || cptOption.name != null && !isIdInner(cptOption) && !isIdInner(exist) && exist.name === cptOption.name + "")) {
    ...
    function makeKeyInfo(mainType, mapResult) {
        ...
        each(mapResult, function(item, index) {
            ...
            var opt = item.option;
            zrUtil.assert(!opt || opt.id == null || !idMap[opt.id], "id duplicates: " + (opt && opt.id));
